<template>
    <div>
        ...
        <div class="txt">
            <p class="title">动画大师今敏，漫画生涯至高代表作，中文首版首发</p>
            <p class="price">￥62</p>
            <div class="count">
                已哆嗦5件
            </div>
        ...
        <ul>
            <li>
                ...
                <span style="margin-left:15px;">发货时间：周一至周五 默认中通快递 顺丰到付</span>
            </li>
            <li>
                <span style="color:#aaa;margin-right:25px;">发货</span>
                <span>48小时发货</span>
            </li>
        </ul>
        <img src="../img/pro/detail2.jpg" alt="" style="width:100%">
        <img src="../img/pro/detail3.jpg" alt="" style="width:100%">
        <img src="../img/pro/detail4.jpg" alt="" style="width:100%">
        <van-goods-action>
